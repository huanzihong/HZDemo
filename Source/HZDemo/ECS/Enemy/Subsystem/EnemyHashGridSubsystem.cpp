...
bool UEnemyHashGridSubsystem::RaycastEnemy(const FVector& RayStart, const FVector& RayDirection, float MaxDistance, FVector& OutHitLocation, FMassEntityHandle& OutHitEntity) const
{
